...
export const metadata = { title: 'Corporate Partnership | Integrain Foundation' }
    ...
    <>
      <section className="hero-gradient text-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-5">Corporate Partnership</h1>
